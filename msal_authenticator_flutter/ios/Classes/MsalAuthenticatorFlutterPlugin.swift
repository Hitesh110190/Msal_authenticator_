import Flutter
import UIKit
import msal_authenticator_flutter
...
// public class MsalAuthenticatorFlutterPlugin: NSObject, FlutterPlugin {
//   public static func register(with registrar: FlutterPluginRegistrar) {
//     let channel = FlutterMethodChannel(name: "msal_authenticator_flutter", binaryMessenger: registrar.messenger())
//     let instance = MsalAuthenticatorFlutterPlugin()
//     registrar.addMethodCallDelegate(instance, channel: channel)
//   }
//
//   public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
